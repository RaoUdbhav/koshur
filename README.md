...
9. **Audio Lab & Phonetics Hub**:
   ...
   - 💬 **Native Conversational Audio Player**: 10 Interactive dialogue drills (*Bazaar Bargaining*, *Noon Chai & Hospitality*, *Meeting Friends*, *Road Navigation*, *Village Inquiries*, *Community Healthcare*, *Valley Weather*, *Hospitality & Safe Journeys*, *Meeting Neighbors*, and *School & Village Education*) with line-by-line speech and slow playback.
10. **Chinar Bazaar & Gamification**: In-app shop with Streak Freezes, Heart Refills, and Kashmiri cultural badges.
11. **Full Reference Library**: Includes **245 hand-checked vocabulary words** across 13 categories and all **1,330 Kashmiri proverbs** by Omkar N. Koul (2006).
